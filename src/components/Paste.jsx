...
const Paste = () => {
  ...
  return (
    <div>
      <input
        className='pl-5 pt-2 pb-3 rounded min-w-[1212px] mb-5 p-2 bg-white border border-gray-300 text-black'
        type='search'
        placeholder='Search paste here...'
        value={searchTerm}
        onChange={(e)=>setSearchTerm(e.target.value)}
      />
      <div className='flex flex-col min-w-[50px] gap-4 rounded border border-gray-300 p-3 text-black'>
        ...
        <hr/>
        {
          filteredData.length>0 && filteredData.map(
            (paste)=>{
              return(
                <div className='border rounded p-5 flex flex-row justify-between gap-3' key={paste?._id}>
                  <div className=''>
                  ...
                  <div className='flex flex-row  justify-center gap-5'>
                    ...
                    <button className='p-2 bg-white border rounded hover:bg-gray-100' onClick={()=>{
